...
namespace gerber
{
    ...
    commandBaseClass GerberSyntaxReader::parseCommand(std::string inputString)
    {
        ...
        else if(std::regex_match(inputString, ADDCommand))
        {
            ...
            while(true)
            {
                ...
                else
                {
                    ...
                    listOfModifiers.push_back(tempDouble);
                    break;
                }
            }
        ...
        gerber::unknownCommand returnUnknownCommand(inputString);
